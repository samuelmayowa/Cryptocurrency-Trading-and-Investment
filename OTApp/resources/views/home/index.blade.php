<?php
header("location: https://www.falconoptions.com");
?>
    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox"  >
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/cloud/app/images/{{$content->getImage('9kHash','img_path')}}" alt="">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="col-lg-8">
            ...
            <div class="owl-carousel testimonials-carousel wow fadeInUp">
              @foreach ($test as $testimony)
                ...
                <img src="{{ $settings->site_address}}/cloud/app/images/{{$testimony->picture}}" class="testimonial-img" alt="">
